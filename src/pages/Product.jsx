		...
		<section className=" mx-auto my-28 grid max-w-6xl grid-cols-2 gap-4 overflow-hidden  rounded-lg  bg-white shadow-lg">
			...
			<div className="flex flex-col gap-5 px-5 py-11 ">
				...
				<div className="flex gap-4">
					<Link to="/cart">
						<button className="relative grid w-60 items-center rounded-lg bg-gradient-to-r from-[#ff6174]  via-[#ff6174] via-30% to-[#ff234e] p-3 text-center    text-lg  text-white before:absolute before:h-full before:w-full before:rounded-lg hover:before:bg-black/10">
							Add to cart
						</button>
					</Link>
